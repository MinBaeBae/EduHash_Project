...
// 마지막 접속일 관련
export const setLastAccessDate = lastAccessDate => ({
  type: "SET_LASTACCESSDATE",
  payload: lastAccessDate
});
...
export const tryLogin = userData => async (dispatch, state, navigate) => {
  ...
  try {
    ...
    if (response.success === "true" && id == "testuser" && pw == "1234") {
...
export const getDateTimes = UserID => async (dispatch, state, navigate) => {
  ...
  const response = await axios
    .get(
      "/healthdata/MockDateTimesAPI.json",
      // {
      //   UserID: UserID
      // },
      // { headers }
...
export const getInBodyData =
  (UserID, dateTimes) => async (dispatch, state, navigate) => {
    ...
    axios
      .all([
        axios.get(
          "/healthdata/MockInBodyDataAPI1.json",
          // {
          //   UserID: UserID,
        ...
        axios.get(
          "/healthdata/MockInBodyDataAPI2.json",
          // {
          //   UserID: UserID,
        ...
        axios.get(
          "/healthdata/MockInBodyDataAPI3.json",
          // {
          //   UserID: UserID,
        ...
        axios.get(
          "/healthdata/MockInBodyDataAPI4.json",
          // {
          //   UserID: UserID,
        ...
        axios.get(
          "/healthdata/MockInBodyDataAPI5.json",
          // {
          //   UserID: UserID,

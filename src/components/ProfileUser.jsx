  ...
  const getPhotourl = async () => {
    try {
      const reponse = await axios
        .get(`/profiledata/userinfo-testuser.json`)
        .then(res => {
    ...
    <>
      <Info>
        ...
        <Contents>
          <PhotoBox>
            <UserPhoto>
              <UPhoto imgUrl={user_photo}></UPhoto>
            </UserPhoto>
          </PhotoBox>
          ...
          <TextBox>
            ...
            <InfoText>
              ...
              <InfoTextLine>
                ...
                <InfoPersonal>{userData.PHONE}</InfoPersonal>
              </InfoTextLine>
              <InfoTextLine>
                <InfoTitle>주소</InfoTitle>
                <InfoPersonal>{userData.ADDRESS}</InfoPersonal>
              </InfoTextLine>
              <InfoTextLine>
                <InfoTitle>생년월일</InfoTitle>
                <InfoPersonal>{userData.BIRTH}</InfoPersonal>
              </InfoTextLine>
            </InfoText>
          </TextBox>
        </Contents>
